...
INSTALLED_APPS = [
    ...
    # TODO: Check if this is really the best option
    'corsheaders',
]
...
# Media files (user-uploaded content, e.g. audio pronunciations).
# Stored on a persistent volume and served by the frontend nginx at /media/.
MEDIA_URL = '/media/'
